...
// V Split fileName into base and extension so that base + ext == fileName
func splitExt2(fileName string) (base, ext string) {
...
func Addd(fileName string, t time.Time) string {
